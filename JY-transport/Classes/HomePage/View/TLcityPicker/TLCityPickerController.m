...
@interface TLCityPickerController () <TLCityGroupCellDelegate, TLSearchResultControllerDelegate,UISearchControllerDelegate>
...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *cancelBarButton = [UIBarButtonItem itemWithIcon:@"return" highIcon:@"return" target:self action:@selector(cancelButtonDown:)];
